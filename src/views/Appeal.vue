...
// Cập nhật hàm startReg để truyền danh sách thẻ vào Selenium
const startReg = async () => {
  if (selectedOption.value) {
    ...
    // Kết hợp danh sách profile với danh sách thẻ
    const dataWithCards = selectedAccounts.map((account, index) => ({
      ...account,
      cardData: cardDataList.value[index % cardDataList.value.length], // Phân bổ thẻ theo vòng lặp
    }));
    const dataJSON = JSON.stringify(dataWithCards);
    ...
    <div class="main-container">
      <div class="header">
        ...
        <div class="w-full h-full flex justify-center items-center">
          <router-link to="/auto-set-campaigns" >AUTO SET CAMP</router-link>
        </div>
        <div class="user-info">
